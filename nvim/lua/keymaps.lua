...
vim.keymap.set('n', '<Space>t<Space>', function() iron.send('sh', string.char(03)) end, { noremap = true })
...
vim.keymap.set('i', 'ik', '<Esc>', { noremap = true })
vim.keymap.set('t', 'ik', '<C-\\><C-n>', { noremap = true })
